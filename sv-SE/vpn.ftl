...
vpn-site-title =
    .aria-label = Startsida för { -vpn-product-name }
...
sign-out = Logga ut
user-avatar =
    .aria-label = Öppna kontonavigering
signed-in-as = Inloggad som: <user>{ $user }</user>
manage-account = Hantera konto
manage-subscription = Hantera prenumerationer
...
download-for-windows-2 = VPN för Windows 10/11
download-for-windows-details-2 = Windows 10/11 (endast 64-bitars)
download-for-android = VPN för Android
download-for-android-details-at2-2 = Version 8 och senare
download-for-ios = VPN för iOS
download-for-ios-details-at2-2 = Version 12.0 och senare
download-for-mac = VPN för Mac
download-for-mac-details-at2-2 = Version 10.14 och senare
download-for-linux = VPN för Linux
download-for-linux-details-at2-2 = Ubuntu 18.04 och senare
available = TILLGÄNGLIGA
coming-soon = Kommer snart
download-page-title =
    .title = Hämta: { -vpn-product-name }
