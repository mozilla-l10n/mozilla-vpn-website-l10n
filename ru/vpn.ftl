...
download-for-windows-details = Windows 10 (только 64-битная версия)
download-for-android = VPN для Android
download-for-android-details = Версия 6 и выше
download-for-ios = VPN для iOS
download-for-ios-details = Версия 13.0 и выше
download-for-mac = VPN для Mac
download-for-mac-details = Версия 10.15 и выше
